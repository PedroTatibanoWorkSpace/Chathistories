    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            new Table({
                ...
                indices: [
                    {
                        name: "IDX_chat_delegations_chat_external_id",
                        columnNames: ["chat_external_id"]
                    },
                    {
                        name: "IDX_chat_delegations_user_external_id",
                ...
                foreignKeys: [
                    {
                        name: "FK_chat_delegations_chat_external_id",
                        columnNames: ["chat_external_id"],
                    ...
                    {
                        name: "FK_chat_delegations_user_external_id",
                        columnNames: ["user_external_id"],
